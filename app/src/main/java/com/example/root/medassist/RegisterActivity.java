...
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        inputmobNum = (EditText) findViewById(R.id.mobNum);
        btnRegister = (Button) findViewById(R.id.btnRegister);
        btnLinkToLogin = (Button) findViewById(R.id.btnLinkToLoginScreen);
        btnRegisterDoc = (Button) findViewById(R.id.RegisterDoc);
        // Progress dialog
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty() && !mobNum.isEmpty()) {
                    registerUser(name, email, password,mobNum);
                } else {
    ...
    private void registerUser(final String name, final String email,
                              final String password, final String mobNum) {
