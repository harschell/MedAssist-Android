...
import com.example.root.medassist.PlayVideoActivity;
import com.example.root.medassist.R;
import com.example.root.medassist.ViewImageActivity;
...
public class ChatAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //Log.v("Chat Adapter" + "getView", mes.getmText());
		if(view == null){
        ...
        if(type == Message.TEXT_MESSAGE){
            //Log.v("Chat Adapter", "Enabling text view"+type);
	...
	private void enableTextView(CacheView cache, String text){
		if(!text.equals("")){
            ...
            //Log.v("Chat adapter","enableTextView" + text);
