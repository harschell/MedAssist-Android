package com.example.root.medassist.Receivers;
...
import com.example.root.medassist.StartAppointmentActivity;
...
//			Log.v(TAG, "WIFI_P2P_PEERS_CHANGED_ACTION");
	...
	public void activateGoToChat(String role){
		if(mActivity.getClass() == StartAppointmentActivity.class){
			((StartAppointmentActivity)mActivity).getGoToChat().setText("Start the chat "+role);
			((StartAppointmentActivity)mActivity).getGoToChat().setVisibility(View.VISIBLE);
			((StartAppointmentActivity)mActivity).getSetChatName().setVisibility(View.VISIBLE);
			((StartAppointmentActivity)mActivity).getSetChatNameLabel().setVisibility(View.VISIBLE);
			((StartAppointmentActivity)mActivity).getDisconnect().setVisibility(View.VISIBLE);
			((StartAppointmentActivity)mActivity).getGoToSettings().setVisibility(View.GONE);
			((StartAppointmentActivity)mActivity).getGoToSettingsText().setVisibility(View.GONE);
		}
	}
